...
- **Implementacje funkcji do OGS** - Przecież sam serwer się nie napisze... ktoś musi zaimplementować funkcję żeby klient poprawnie reagował :P<br><br>
		...
		**Q: A co jak umiem pythona?**<br>
		To w sam raz! możesz wykonać przykładowe skrypty, które pomagają sprawdzić działanie klienta (przydatne, kiedy nie ma opcji używania dwóch klientów na raz :P). Na przykład możesz wykonać:<br>
		- Kliencką Papuge - sprawdzian, który odczyta wysłany do niej tekst, który potem będzie papugować<br>
		- Głuchy telefon - sprawdzian, który wykrywa że wiadomość została wysłana, ale odpisuje "Co?/Słucham?/Napisz jeszcze raz, bo nie umiem czytać!"<br>
